    ...
    <section id="feeding-calculator" className="py-24 sm:py-28 bg-cream">
      <div className="max-w-7xl mx-auto container-px">
        <div className="relative rounded-[2.25rem] bg-gradient-to-br from-soft-blue via-white to-orange-soft/60 overflow-hidden ring-1 ring-teal/10 shadow-card">
          <PawMark className="absolute top-6 left-8 opacity-15 rotate-[-12deg]" color="#138fa1" size={26} />
          <PawMark className="absolute bottom-8 right-10 opacity-15 rotate-[18deg]" color="#138fa1" size={32} />
          ...
          <div className="grid lg:grid-cols-12 gap-10 lg:gap-14 items-center p-7 sm:p-10 lg:p-16">
            ...
            <div className="lg:col-span-7">
              <div className="relative pb-10 lg:pb-0">
                ...
                <div className="absolute -left-2 sm:-left-6 -top-5 sm:top-7 bg-white rounded-3xl shadow-card px-5 py-4 ring-4 ring-soft-blue max-w-[205px]">
                ...
                <div className="relative -mt-8 lg:mt-0 lg:absolute lg:right-4 lg:-bottom-9 bg-white rounded-2xl shadow-card p-5 max-w-sm lg:max-w-xs mx-auto lg:mx-0">
